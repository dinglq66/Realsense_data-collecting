...
if __name__ == "__main__":
    ...
    parser.add_argument("--model_def", type=str, default="./yolov3/yolov3.cfg", help="path to model definition file")
    parser.add_argument("--weights_path", type=str, default="./yolov3/yolov3.weights", help="path to weights file")
    parser.add_argument("--class_path", type=str, default="./yolov3/coco.names", help="path to class label file")
    ...
    parser.add_argument("--end_frame", type=int, default=700, help="frame to start")
    parser.add_argument("--data_dir", type=str, default="./data/exp/2021-06-25-14-35-45", help="data dir"
    ...
    for img_file in img_list:
        ...
        print("the shape of detections:", detections.shape)
        # print(detections[0])
        detections = [i for i in detections if i[5] == 41]
        if len(detections) != 0:
            x1_s, y1_s, x2_s, y2_s, conf_s, cls_pred_s = 0, 0, 0, 0, 0, 0
            ...
            fout.write("{:.2f}\n".format(depth_image[int(y1+y2)//2, int(x1+x2)//2]))
        else:
            print("lost")
            fout.write("{}\n".format(-1))
        cv2.imshow("RGB", img)
        cv2.imwrite("./data/result_detect/0625_{}.jpg".format(cnt), img)
